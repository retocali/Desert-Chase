var mainState = {
    ...
    create: function() {
        ...
        // Mute button
        muted = game.add.button(game.world.centerX - TILE_SIZE*(BOARD_WIDTH/2-1), game.world.centerY - TILE_SIZE*(BOARD_HEIGHT/2+1), 'muted', muteClick, this);
        muted.anchor.setTo(0.5,0.5)
        muted.scale.setTo(0.3,0.3);

        mute = game.add.button(game.world.centerX - TILE_SIZE*(BOARD_WIDTH/2-1), game.world.centerY - TILE_SIZE*(BOARD_HEIGHT/2+1), 'mute', muteClick, this);
